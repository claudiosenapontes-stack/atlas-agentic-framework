...
/**
 * Guard Agent - Security & Validation Specialist
 */

const Redis = require('ioredis');

const config = {
  agentId: process.env.AGENT_ID || 'guard-unknown',
  agentName: process.env.AGENT_NAME || 'Guard',
  agentType: process.env.AGENT_TYPE || 'guard',
