...
/**
 * RetryQueue — Gate 5A Durable Execution Component
 * 
 * Displays retry queue and failure recovery status.
    ...
    <div className="bg-[#111214] rounded-lg border border-[#1F2226] p-3">
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          <RotateCcw className="w-3.5 h-3.5 text-[#16C784]" />
          <span className="text-xs font-medium text-[#9BA3AF]">Retry Queue</span>
        </div>
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between text-xs">
          <span className="text-[#6B7280]">Pending Retries</span>
          <span className="text-white font-mono">—</span>
        </div>
        <div className="flex items-center justify-between text-xs">
          <span className="text-[#6B7280]">Max Attempts</span>
          <span className="text-white font-mono">—</span>
        </div>
        <div className="flex items-center justify-between text-xs">
